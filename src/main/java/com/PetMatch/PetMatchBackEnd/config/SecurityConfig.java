    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v1/api/animais/**", "/v1/api/eventos/**", "/api/adocao/animal/**/lista-espera", "/api/adocao/interesse/**/avaliar").hasAuthority("ONG")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/adocao/animal/**/match").authenticated()
